...
const styles = {
    container: {
        minHeight: '100vh',
        background:
            'linear-gradient(to bottom right, #f5f3ff, #faf5ff, #fdf4ff)',
        padding: '2rem'
    },
    card: {
        maxWidth: '56rem',
            ...
            h('div', { style: styles.card }, [
                h('div', { style: styles.header }, [
                    ...
                    h(
                        ...
                        'Built with Vue 3.3 + Composition API + TypeScript'
                    ),
                    h(
                        'div',
                        { style: styles.badge },
                ...
                h('div', { style: styles.navBox }, [
                    ...
                    h(
                        'p',
                        { style: styles.navDesc },
                        'This Vue 3 app has multiple pages with internal routing'
                    ),
                ...
                h('div', { style: styles.footer }, [
                    ...
                    h(
                        ...
                        'Zero-bundler federation • Multi-framework • TypeScript'
                    )
                ])
            ])
        ]);
