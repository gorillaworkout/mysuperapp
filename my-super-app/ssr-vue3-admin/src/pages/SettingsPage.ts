    ...
    render() {
        return h('div', { class: 'admin-settings', style: 'padding: 2rem;' }, [
            ...
            h('div', { style: 'background: #f3f4f6; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1rem;' }, [
                ...
                this.navLink('/admin', 'display: inline-block; background: #4b5563; color: white; padding: 0.5rem 1rem; text-decoration: none; border-radius: 0.25rem;', '← Back to Dashboard')
            ]),
