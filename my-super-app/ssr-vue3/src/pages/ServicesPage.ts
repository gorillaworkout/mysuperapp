...
const styles = {
  container: {
    minHeight: '100vh',
    background: 'linear-gradient(to bottom right, #faf5ff, #f5f3ff, #ede9fe)',
    padding: '2rem'
  },
  card: {
    maxWidth: '56rem',
    ...
    return h('div', { style: styles.container }, [
      h('div', { style: styles.card }, [
        h('div', { style: styles.header }, [
          ...
          h('p', { style: styles.subtitle }, 'Services powered by Vue 3')
        ]),
        ...
        h('div', { style: styles.navSection }, [
          ...
          h('div', { style: styles.navButtons }, [
            ...
            h('span', { style: styles.currentPage }, 'Current: Services Page')
          ])
        ]),

        h('div', { style: styles.grid }, [
          h('div', { style: styles.serviceBox }, [
            h('h3', { style: styles.boxTitle }, '🚀 Available Services'),
            h('ul', { style: styles.list }, [
              h('li', { style: styles.listItem }, '• API Gateway'),
              h('li', { style: styles.listItem }, '• Authentication'),
              h('li', { style: styles.listItem }, '• Data Pipeline'),
              h('li', { style: styles.listItem }, '• Real-time Events')
            ])
          ]),
          h('div', { style: styles.techBox }, [
            h('h3', { style: styles.boxTitle }, '⚙️ Technology'),
            h('ul', { style: styles.list }, [
              h('li', { style: styles.listItem }, '• Vue 3 Composition API'),
              h('li', { style: styles.listItem }, '• TypeScript 5'),
              h('li', { style: styles.listItem }, '• ESMX Federation'),
              h('li', { style: styles.listItem }, '• Micro-Frontend Architecture')
            ])
          ])
        ]),

        h('div', { style: styles.footer }, [
          h('h3', { style: styles.footerTitle }, '🛣️ Route: /vue3/services'),
          h('p', { style: styles.footerDesc }, 'Services page of the Vue 3 micro-frontend')
        ])
      ])
    ]);
  }
