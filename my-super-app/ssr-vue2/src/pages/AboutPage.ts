    ...
    return h('div', { style: styles.container }, [
      h('div', { style: styles.card }, [
        ...
        h('div', { style: styles.grid }, [
          ...
          h('div', { style: styles.cyanBox }, [
            ...
            h('ul', { style: styles.list }, [
              h('li', { style: styles.listItem }, '• /vue2 → Home Page'),
              h('li', { style: styles.listItem }, '• /vue2/about → About Page'),
        ...
        h('div', { style: styles.footer }, [
          h('h3', { style: styles.footerTitle }, '🛣️ Route: /vue2/about'),
          h('p', { style: styles.footerDesc }, 'This is the second page of the Vue 2 micro-frontend')
        ])
      ])
    ]);
  }
